...
headers = {
    ...
    'x-language': 'uk',
    'x-referer': 'https://hotline.ua/computer/noutbuki-netbuki/',
    'x-request-id': 'a70f355a31bcf2e4866bb564999c8c58',
    'x-token': '40197de2-76a2-469b-b211-a839fe0a24fb',
}

json_data = {
    'operationName': 'getFilteredProductsCount',
    'variables': {
        'path': 'noutbuki-netbuki',
        'filter': '33373',
    },
...
response = requests.post('https://hotline.ua/svc/frontend-api/graphql', headers=headers, json=json_data)
